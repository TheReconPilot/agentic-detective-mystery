...
**Progress so far:** M1–M10 done, plus M7 (polish: architecture diagram, badges, CI, README sample session, `v0.1.0` tag). The only milestone still on the roadmap is M11 (scripted mid-case "beats").
